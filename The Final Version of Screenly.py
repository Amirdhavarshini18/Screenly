...
def display_images():
    ...
    image_paths = [
        ('C:/Users/amird/Downloads/amaran img.jpg','Amaran'),
        ('C:/Users/amird/Downloads/dear comrade img.jpeg','Dear Comrade'),
        ('C:/Users/amird/Downloads/vtv img.jpeg','VTV'),
        ('C:/Users/amird/Downloads/Shershaah img.jpg','Shershaah')
    ]
...
def show_theater_selection(movie_name):
    theaters = ["INOX", "PVR cinemas", "BROADWAY cinemas"]
...
def show_showtimes_and_dates(movie_name, theater_name):
    ...
    dates = ["Dec 5, 2024", "Dec 6, 2024", "Dec 7, 2024"]
...
def show_billing_page(movie_name, theater_name, selected_date, selected_showtime, selected_seats, base_amount, tax_amount, service_charge_total, total_amount):
    ...
    billing_label = tk.Label(billing_window, text="Booking Confirmation", font=("Raleway", 16))
...
for frame in (signup_frame, login_frame, main_page_frame):
...
# Signup frame
canvas1, bg_image1 = set_background(signup_frame, "C:/Users/amird/Downloads/mini proj photo.jpg")
...
# Login frame
canvas2, bg_image2 = set_background(login_frame, "C:/Users/amird/Downloads/mini proj photo.jpg")
...
# Main page frame
canvas3, bg_image3 = set_background(main_page_frame, "C:/Users/amird/Downloads/boto.jpg")
